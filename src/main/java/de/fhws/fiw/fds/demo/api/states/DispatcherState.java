...
package de.fhws.fiw.fds.demo.api.states;

import de.fhws.fiw.fds.demo.api.states.students.StudentRelTypes;
import de.fhws.fiw.fds.demo.api.states.students.StudentUri;
...
public class DispatcherState extends AbstractGetDispatcherState {
	...
	protected void defineTransitionLinks() {
		addLink(StudentUri.PATH_ELEMENT, StudentRelTypes.GET_ALL_STUDENTS);
	}
